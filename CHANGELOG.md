...
Renamed base package com.dlb.chess → io.github.dlbbld.ashlarchess (the old namespace mapped to a domain not controlled by the project). Earlier entries use the new package name for consistency; releases before 17.0.0 shipped it as io.github.dlbbld.ashlarchess.

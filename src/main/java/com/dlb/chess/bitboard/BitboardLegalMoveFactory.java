...
public final class BitboardLegalMoveFactory {
   ...
   * {@link BitboardPosition#legalMoves} and run through {@link #toLegalMove}; castling moves come from the
   * bitboard-based castling bridge {@link AbstractLegalMoves#calculateCastlingLegalMoves(BitboardPosition, Side, CastlingRight)}.
   * Returns an {@link ImmutableList} sorted by {@link LegalMove#compareTo}, matching the public contract of the
   * previous {@code AbstractLegalMoves.calculateLegalMoves} path.
   */
  public static ImmutableList<LegalMove> calculateLegalMoves(BitboardPosition bitboardPosition, Side havingMove,
    ...
    result.addAll(AbstractLegalMoves.calculateCastlingLegalMoves(bitboardPosition, havingMove, castlingRight));

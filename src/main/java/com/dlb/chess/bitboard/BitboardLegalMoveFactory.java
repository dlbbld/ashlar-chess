...
public final class BitboardLegalMoveFactory {
   ...
   * StaticPosition-based path via {@link AbstractLegalMoves#calculateCastlingLegalMoves}. Returns an
   ...
   */
  public static ImmutableList<LegalMove> calculateLegalMoves(BitboardPosition bitboardPosition,
      StaticPosition staticPosition, Side havingMove, CastlingRight castlingRight, long enPassantBit) {
    ...
    result.addAll(AbstractLegalMoves.calculateCastlingLegalMoves(staticPosition, havingMove, castlingRight));

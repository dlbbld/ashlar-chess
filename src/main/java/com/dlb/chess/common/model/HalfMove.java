...
public record HalfMove(int index, int halfMoveCount, int fullMoveNumber, int halfMoveClock,
    DynamicPosition dynamicPosition, int countRepetition, String san, Piece movingPiece,

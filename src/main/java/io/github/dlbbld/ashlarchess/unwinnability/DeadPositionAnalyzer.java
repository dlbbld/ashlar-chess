...
public final class DeadPositionAnalyzer {
  ...
  public static DeadPositionFullVerdict deadPositionFull(Board board) {
    ...
    if (white == UnwinnabilityFullVerdict.WINNABLE_HELPMATE
        || white == UnwinnabilityFullVerdict.WINNABLE_BY_THEOREM) {
    ...
    if (black == UnwinnabilityFullVerdict.WINNABLE_HELPMATE
        || black == UnwinnabilityFullVerdict.WINNABLE_BY_THEOREM) {
      return DeadPositionFullVerdict.ALIVE;
    }

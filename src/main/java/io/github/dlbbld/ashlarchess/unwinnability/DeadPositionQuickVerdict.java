 ...
 * checkmate by any sequence of legal moves (FIDE 5.2.2). The quick analysis is deliberately two-valued: it either
 * proves the position dead or leaves it open. It never claims a position alive - establishing that a side can win is
 * the complete (full) analysis's job.
 */

 ...
 * {@link LenientSanParseResult} so callers can switch between strict and lenient parsing by changing one
 ...
 */
public record StrictSanParseResult(MoveSpecification moveSpecification) {

 ...
 *
 * <p>
 * Carries only the boundary's chronological position (sequence start, move count, fullmove number, side to move) - NOT
 * a specific candidate move. Multiple non-zeroing legal moves at the same boundary collapse into a single entry:

...
class TestStrictFenSemanticParser {
  ...
  void testParseFenException() {
    checkParseFenException("", StrictFenSemanticValidationProblem.INVALID_FORMAT);

    // position format
    checkParseFenException("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR/ w KQkq - 0 1",
        StrictFenSemanticValidationProblem.INVALID_POSITION_ENDS_WITH_FORWARD_SLASH);
    ...
    checkParseFenException("//rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",
        StrictFenSemanticValidationProblem.INVALID_POSITION_EMPTY_RANK);
    ...
    checkParseFenException("RNBQKBNR//rn w KQkq - 0 1", StrictFenSemanticValidationProblem.INVALID_POSITION_EMPTY_RANK);
    ...
    checkParseFenException("rnbq1rk1/pppp1Bpp/5n2/4p3/1b2P3/5N2/PPPP1PPP/RNBQ1RK1 w - - 0 5",
        StrictFenSemanticValidationProblem.INVALID_POSITION_CHECK);
    ...
    checkParseFenException("r3k2r/8/8/8/8/8/8/R2K3R x - - 0 100",
        StrictFenSemanticValidationProblem.INVALID_SIDE_TO_MOVE_RANGE);
    ...
    checkParseFenException("r3k2r/8/8/8/8/8/8/R2K3R w x - 0 100",
        StrictFenSemanticValidationProblem.INVALID_CASTLING_RIGHT_RANGE);
    ...
    checkParseFenException("r3k2r/8/8/8/8/8/8/R2K3R w KQkq - 0 100",
        StrictFenSemanticValidationProblem.INVALID_CASTLING_RIGHT_WHITE_BOTH);
    ...
    checkParseFenException("r3k2r/8/8/8/8/8/8/R2K3R w Kkq - 0 100",
        StrictFenSemanticValidationProblem.INVALID_CASTLING_RIGHT_WHITE_KINGSIDE);
    ...
    checkParseFenException("r3k2r/8/8/8/8/8/8/R2K3R w Qkq - 0 100",
        StrictFenSemanticValidationProblem.INVALID_CASTLING_RIGHT_WHITE_QUEENSIDE);
    ...
    checkParseFenException("r2k3r/8/8/8/8/8/8/RN2K1NR w KQkq - 0 100",
        StrictFenSemanticValidationProblem.INVALID_CASTLING_RIGHT_BLACK_BOTH);
    ...
    checkParseFenException("r2k3r/8/8/8/8/8/8/RN2K1NR w Kk - 0 100",
        StrictFenSemanticValidationProblem.INVALID_CASTLING_RIGHT_BLACK_KINGSIDE);
    ...
    checkParseFenException("r2k3r/8/8/8/8/8/8/RN2K1NR w Qq - 0 100",
        StrictFenSemanticValidationProblem.INVALID_CASTLING_RIGHT_BLACK_QUEENSIDE);
    ...
    checkParseFenException("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - x 1",
        StrictFenSemanticValidationProblem.INVALID_HALF_MOVE_CLOCK_RANGE);
    ...
    checkParseFenException("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 x",
        StrictFenSemanticValidationProblem.INVALID_FULL_MOVE_NUMBER_RANGE);
    ...
    checkParseFenException("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 0",
        StrictFenSemanticValidationProblem.INVALID_FULL_MOVE_NUMBER_ZERO);
  ...
  void testParseFenMaxValues() {
    ...
    // Halfmove clock at and above the 75-move rule threshold (150) is accepted - the 75-move rule
    // is surfaced as a queryable predicate, not enforced at FEN import, so a position with
    // halfmove clock above 150 is a legitimate FEN.
    ...
    checkParseFenException(
        ...
        StrictFenSemanticValidationProblem.INVALID_FULL_MOVE_NUMBER_TOO_BIG_ABSOLUTE);
  ...
  void testParseFenConverted() {
    ...
    final Fen actual = StrictFenSemanticParser.parse(FenConstants.FEN_INITIAL_STR);
  ...
  void testParseFenNumberOfPieces() {
    checkParseFenException("rnbqkbnr/pppppppp/8/8/8/K7/PPPPPPPP/RNBQKBNR w kq - 18 10",
        StrictFenSemanticValidationProblem.INVALID_WHITE_TOO_MANY_KINGS);
    checkParseFenException("rnbqkbnr/pppppppp/8/3k4/8/8/PPPPPPPP/RNBQKBNR b KQ - 19 10",
        StrictFenSemanticValidationProblem.INVALID_BLACK_TOO_MANY_KINGS);
    ...
    checkParseFenException("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQ1BNR w KQkq - 0 10",
        StrictFenSemanticValidationProblem.INVALID_WHITE_NO_KING);
    checkParseFenException("rnbq1bnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 10",
        StrictFenSemanticValidationProblem.INVALID_BLACK_NO_KING);
    ...
    checkParseFenException("rnbqkbnr/pppppppp/8/8/8/P7/PPPPPPPP/RNBQKBNR w KQkq - 0 10",
        StrictFenSemanticValidationProblem.INVALID_WHITE_TOO_MANY_PAWNS);
    checkParseFenException("rnbqkbnr/pppppppp/3p4/8/8/8/PPPPPPPP/RNBQKBNR b KQkq - 0 10",
        StrictFenSemanticValidationProblem.INVALID_BLACK_TOO_MANY_PAWNS);
    ...
    checkParseFenException("rnbqkbnr/pppppppp/8/8/R7/8/PPPPPPPP/RNBQKBNR w KQkq - 18 10",
        StrictFenSemanticValidationProblem.INVALID_WHITE_TOO_MANY_ROOKS);
    checkParseFenException("rnbqkbnr/pppppppp/3r4/8/8/8/PPPPPPPP/RNBQKBNR b KQkq - 19 10",
        StrictFenSemanticValidationProblem.INVALID_BLACK_TOO_MANY_ROOKS);
    ...
    checkParseFenException("rnbqkbnr/pppppppp/8/8/N7/8/PPPPPPPP/RNBQKBNR w KQkq - 0 10",
        StrictFenSemanticValidationProblem.INVALID_WHITE_TOO_MANY_KNIGHTS);
    checkParseFenException("rnbqkbnr/pppppppp/3n4/8/8/8/PPPPPPPP/RNBQKBNR b KQkq - 0 10",
        StrictFenSemanticValidationProblem.INVALID_BLACK_TOO_MANY_KNIGHTS);
    ...
    checkParseFenException("rnbqkbnr/pppppppp/8/8/Q7/8/PPPPPPPP/RNBQKBNR w KQkq - 18 10",
        StrictFenSemanticValidationProblem.INVALID_WHITE_TOO_MANY_QUEENS);
    checkParseFenException("rnbqkbnr/pppppppp/3q4/8/8/8/PPPPPPPP/RNBQKBNR b KQkq - 19 10",
        StrictFenSemanticValidationProblem.INVALID_BLACK_TOO_MANY_QUEENS);
  ...
  private static void checkParseFenException(String fen, StrictFenSemanticValidationProblem expected) {
    ...
    try {
      StrictFenSemanticParser.parse(fen);
    } catch (final StrictFenSemanticValidationException e) {
      actual = e.getStrictFenSemanticValidationProblem();
    }
  ...
  private static void checkParseFenSuccess(String fen) {
    ...
    try {
      StrictFenSemanticParser.parse(fen);
    } catch (@SuppressWarnings("unused") final StrictFenSemanticValidationException e) {
      isException = true;
    }

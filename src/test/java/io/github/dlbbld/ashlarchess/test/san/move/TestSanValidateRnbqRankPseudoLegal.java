...
class TestSanValidateRnbqRankPseudoLegal {
  ...
  void testWhiteNotReachableSingle() {
    ...
    final Board board = Board.fromFenStrict("k7/8/8/8/8/8/P7/R3K3 w - - 0 1");
  ...
  void testBlackNotReachableSingle() {
    ...
    final Board board = Board.fromFenStrict("r3k3/p7/8/8/8/8/8/4K3 b - - 0 1");
  ...
  void testWhiteNotReachableMultiple() {
    ...
    final Board board = Board.fromFenStrict("k7/8/8/8/8/8/P6P/R3K2R w - - 0 1");
  ...
  void testBlackNotReachableMultiple() {
    ...
    final Board board = Board.fromFenStrict("r3k2r/p6p/8/8/8/8/8/4K3 b - - 0 1");
  ...
  void testWhiteKingInCheckMultiple() {
    ...
    final Board board = Board.fromFenStrict("k7/7p/8/b3b3/1B1B4/2K5/8/8 w - - 0 1");
  ...
  void testBlackKingInCheckMultiple() {
    ...
    final Board board = Board.fromFenStrict("8/8/2k5/1b1b4/B3B3/8/7P/K7 b - - 0 1");

...
class TestChessRuleAnalyzerScenarios {
  ...
  void testWhiteMovingPiece() {
    ...
    TestChessRuleAnalyzerScenariosSupport.check(board, move, MoveCheck.MOVE_SPEC_FROM_SQUARE_EMPTY);
    ...
    TestChessRuleAnalyzerScenariosSupport.check(board, move, MoveCheck.MOVE_SPEC_FROM_SQUARE_OCCUPIED_BY_OPPONENT);
    ...
    TestChessRuleAnalyzerScenariosSupport.check(board, move, MoveCheck.MOVEMENT_NOT_POSSIBLE);
    ...
    TestChessRuleAnalyzerScenariosSupport.check(board, move, MoveCheck.MOVE_SPEC_PAWN_NON_PROMOTION_PROMOTION_PIECE);
  ...
  void testWhiteCapturingNonPawn() {
    ...
    TestChessRuleAnalyzerScenariosSupport.check(board, move, MoveCheck.MOVEMENT_TO_SQUARE_OCCUPIED_BY_OWN_PIECE);
  ...
  void testWhiteCapturingPawn() {
    ...
    TestChessRuleAnalyzerScenariosSupport.check(board, move, MoveCheck.MOVEMENT_PAWN_DIAGONAL_OWN_PIECE);
    ...
    TestChessRuleAnalyzerScenariosSupport.check(board, move, MoveCheck.MOVEMENT_PAWN_EN_PASSANT_WRONG_RANK);
  ...
  void testWhiteKingMoves() {
    ...
    move = new MoveSpecification(E1, E2);
    TestChessRuleAnalyzerScenariosSupport.check(board, move, MoveCheck.KING_CAPTURES_GUARDED_PIECE);
    ...
    TestChessRuleAnalyzerScenariosSupport.check(board, move, MoveCheck.KING_MOVES_NEXT_TO_OPPONENT_KING);
  ...
  void testWhitePromotionPieceWronglySet() {
    ...
    TestChessRuleAnalyzerScenariosSupport.check(board, move, MoveCheck.MOVE_SPEC_NON_PAWN_PROMOTION_PIECE_SET);
    ...
    TestChessRuleAnalyzerScenariosSupport.check(board, move, MoveCheck.MOVE_SPEC_PAWN_PROMOTION_NO_PROMOTION_PIECE);
  ...
  void testLongRangePieces() {
    ...
    // rook
    {
      ...
      TestChessRuleAnalyzerScenariosSupport.check(fen, move, MoveCheck.MOVEMENT_LONG_RANGE_PIECE_JUMPS_OVER_PIECE);
    }
    // bishop
    {
  ...
  void testAllPiecesButKingKingLeftInCheck() {
    ...
    // rook
    {
      ...
      TestChessRuleAnalyzerScenariosSupport.check(fen, move, MoveCheck.ALL_BUT_KING_KING_LEFT_IN_CHECK);
    }
    // knight
    {
      final String fen = "rnbqk1nr/pppp1ppp/8/4p3/4P3/2N2N2/PPPP1bPP/R1BQKB1R w KQkq - 0 4";
  ...
  void testKingInCheckRemainsInCheckLegalMoves() {
    ...
    // rook checking
    {
      ...
      TestChessRuleAnalyzerScenariosSupport.check(fen, move, MoveCheck.KING_MOVES_TO_ATTACKED_EMPTY_SQUARE);
    }
    // knight checking
    {
  ...
  void testKingCapturesGuardedPiece() {
    ...
    // rook
    {
      ...
      TestChessRuleAnalyzerScenariosSupport.check(fen, move, MoveCheck.KING_CAPTURES_GUARDED_PIECE);
    }

...
package io.github.dlbbld.ashlarchess.test.pgntest.enums;
...
public enum PgnTest {
  ...
  CHA_CHASOLVER_CHALLENGES_EXCEPTIONS(false, "cha/chasolverChallenges/exceptions"),
  CHA_CHASOLVER_CHALLENGES_SUCCESS(false, "cha/chasolverChallenges/success"),

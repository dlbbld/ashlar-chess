...
class TestValidateNewMove {
  ...
  void testMoveSpecFromSquareEmpty() {
    TestValidateNewMoveSupport.check(new Board(), new MoveSpecification(E3, E4), MoveCheck.MOVE_SPEC_FROM_SQUARE_EMPTY);
  }
  ...
  void testMoveSpecNonPawnPromotionPieceSet() {
    TestValidateNewMoveSupport.check(new Board(), new MoveSpecification(B1, C3, PromotionPieceType.QUEEN),
  ...
  void testMoveSpecPawnNonPromotionPromotionPiece() {
    TestValidateNewMoveSupport.check(new Board(), new MoveSpecification(E2, E4, PromotionPieceType.QUEEN),
  ...
  void testMoveSpecPawnPromotionNoPromotionPiece() {
    TestValidateNewMoveSupport.check("7k/4P3/8/8/8/8/8/4K3 w - - 0 1", new MoveSpecification(E7, E8),
  ...
  void testMovementNotPossible() {
    TestValidateNewMoveSupport.check(new Board(), new MoveSpecification(B1, B4), MoveCheck.MOVEMENT_NOT_POSSIBLE);
  }
  ...
  void testMovementLongRangePieceJumpsOverPiece() {
    TestValidateNewMoveSupport.check("7k/8/8/8/P7/8/8/R3K3 w - - 0 1", new MoveSpecification(A1, A8),
  ...
  void testMovementPawnForwardTwoSquare() {
    // jump-over occupied
    TestValidateNewMoveSupport.check("4k3/8/8/8/8/4n3/4P3/4K3 w - - 0 1", new MoveSpecification(E2, E4),
  ...
  void testMovementPawnForwardOneSquare() {
    // own piece blocks
    TestValidateNewMoveSupport.check("4k3/8/8/8/8/4N3/4P3/4K3 w - - 0 1", new MoveSpecification(E2, E3),
  ...
  void testMovementPawnDiagonalOwnPiece() {
    TestValidateNewMoveSupport.check("4k3/8/8/8/8/3N4/4P3/4K3 w - - 0 1", new MoveSpecification(E2, D3),
  ...
  void testMovementPawnEnPassantWrongRank() {
    TestValidateNewMoveSupport.check("4k3/8/8/8/4P3/8/8/4K3 w - - 0 1", new MoveSpecification(E4, D5),
  ...
  void testMovementPawnEnPassantNoImmediateBeforeTwoSquareAdvance() {
    TestValidateNewMoveSupport.check("4k3/8/8/4P3/8/8/8/4K3 w - - 0 1", new MoveSpecification(E5, D6),
  ...
  void testKingMovesToAttackedEmptySquare() {
    TestValidateNewMoveSupport.check("4kr2/8/8/8/8/8/8/4K3 w - - 0 1", new MoveSpecification(E1, F1),
  ...
  void testAllButKingKingExposedToCheck() {
    TestValidateNewMoveSupport.check("4r2k/8/8/8/8/8/4N3/4K3 w - - 0 1", new MoveSpecification(E2, C3),
  ...
  void testKingCastlingFinalNoRightUnknownFenImport() {
    TestValidateNewMoveSupport.check("rnbqk2r/pppp1ppp/5n2/2b1p3/2B1P3/5N2/PPPP1PPP/RNBQK2R w Qkq - 0 25",
  ...
  void testKingCastlingTemporarySquaresNotEmpty() {
    TestValidateNewMoveSupport.check("r1bqkbnr/pppppppp/2n5/8/8/5N2/PPPPPPPP/RNBQKB1R w KQkq - 0 25",
  ...
  void testKingCastlingTemporaryKingInCheck() {
    TestValidateNewMoveSupport.check("rnbqk2r/pppp1ppp/5n2/4p3/2B1P3/2N2N2/PPPP1bPP/R1BQK2R w KQkq - 0 5",
  ...
  void testKingCastlingTemporaryKingEndsInCheck() {
    TestValidateNewMoveSupport.check("rnbqk1nr/pppp1ppp/4p3/2b5/2B1P3/5P1N/PPPP2PP/RNBQK2R w KQkq - 0 25",

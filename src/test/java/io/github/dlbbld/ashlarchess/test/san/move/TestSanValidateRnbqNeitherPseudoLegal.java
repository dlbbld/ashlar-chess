...
class TestSanValidateRnbqNeitherPseudoLegal {
  ...
  void testWhiteNotReachableMultiple() {
    ...
    final Board board = Board.fromFenStrict("k7/8/8/8/PPPPPPPP/8/8/1N2K1N1 w - - 0 1");
  ...
  void testBlackNotReachableMultiple() {
    ...
    final Board board = Board.fromFenStrict("1n2k1n1/8/8/pppppppp/8/8/8/4K3 b - - 0 1");
  ...
  void testWhiteKingInCheckMultiple() {
    ...
    final Board board = Board.fromFenStrict("k7/8/8/8/1b6/6b1/3N1N2/4K3 w - - 0 1");
  ...
  void testBlackKingInCheckMultiple() {
    ...
    final Board board = Board.fromFenStrict("4k3/3n1n2/6B1/1B6/8/8/8/K7 b - - 0 1");
  ...
  void testWhiteKingLeftInCheckMultiple() {
    ...
    final Board board = Board.fromFenStrict("r6k/8/3R4/8/8/3R4/8/K7 w - - 0 1");
  ...
  void testBlackKingLeftInCheckMultiple() {
    ...
    // but neither resolves check on a-file.
    final Board board = Board.fromFenStrict("k7/8/3r4/8/8/3r4/8/R6K b - - 0 1");
    checkException("Rd5", board, SanValidationProblem.KING_LEFT_IN_CHECK_RNBQ_NEITHER_MULTIPLE);
  }

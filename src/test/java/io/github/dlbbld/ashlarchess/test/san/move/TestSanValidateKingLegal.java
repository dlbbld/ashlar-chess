...
class TestSanValidateKingLegal {
  ...
  void testBlackNotReachable() {
    ...
    final Board board = Board.fromFenStrict("4k3/8/8/8/8/8/8/R6K b - - 0 1");
  ...
  void testWhiteCaptureNotReachable() {
    ...
    final Board board = Board.fromFenStrict("r6k/8/8/8/4n3/8/8/4K3 w - - 0 1");
  ...
  void testBlackCaptureNotReachable() {
    ...
    final Board board = Board.fromFenStrict("4k3/8/8/4N3/8/8/8/R6K b - - 0 1");

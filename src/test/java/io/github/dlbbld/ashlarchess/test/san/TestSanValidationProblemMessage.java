...
class TestSanValidationProblemMessage {
  ...
  void testDestinationPawn() {
    ...
    {
      final Board board = Board.fromFenStrict("8/8/8/4k3/4P3/8/8/K7 w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("7K/8/8/3k4/8/8/4P3/8 w - - 0 1");
  ...
  void testKingCastling() {
    ...
    {
      final Board board = Board.fromFenStrict("r3k2r/pppp1ppp/8/4q3/8/8/PPPP1PPP/R3K2R w KQkq - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("rnbqk2r/ppppppbp/4Nnp1/8/8/8/PPPPPPPP/R1BQKBNR b KQkq - 0 25");
    ...
    {
      final Board board = Board.fromFenStrict("rnbqk1nr/pppp1ppp/4p3/2b5/2B1P3/5P1N/PPPP2PP/RNBQK2R w KQkq - 0 25");
  ...
  void testNotReachable() {
    ...
    {
      final Board board = Board.fromFenStrict("rnbqkbnr/ppp1pppp/8/3p4/8/8/PPPPPPPP/RNBQKBNR w - - 0 2");
    ...
    {
      final Board board = Board.fromFenStrict("r6k/8/8/8/8/8/8/4K3 w - - 0 1");
    ...
    // move diagonally).
    {
      final Board board = Board.fromFenStrict("7k/8/8/8/8/8/1P6/R6K w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("7k/R7/8/8/8/8/R7/6K1 w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("7k/R7/8/8/8/8/8/6K1 w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("7k/R5R1/8/8/8/8/8/6K1 w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("7k/R7/8/P7/8/8/8/6K1 w - - 0 1");
  ...
  void testKingLeftInCheck() {
    ...
    {
      final Board board = Board.fromFenStrict("4k3/8/8/8/8/8/4P3/4K2r w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("k7/8/8/8/8/8/1R6/3K3r w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("k7/8/8/1R6/8/2R5/8/3K3r w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("1k6/R7/8/8/8/8/R7/3K3r w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("1k6/8/8/R7/8/8/8/3K3r w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("1k6/8/8/R1R5/8/8/8/3K3r w - - 0 1");
  ...
  void testKingExposedToCheck() {
    ...
    {
      final Board board = Board.fromFenStrict("4k3/8/8/b7/8/8/3P4/4K3 w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("4k3/4r3/8/8/4R3/8/8/4K3 w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("2r4k/8/8/8/2R5/8/8/2K2R1r w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("7k/8/b7/1R6/2K5/1R6/b7/8 w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("7k/8/8/b5b1/1R3R2/8/3K4/8 w - - 0 1");
  ...
  void testKingOnlySafetyReasons() {
    ...
    {
      final Board board = Board.fromFenStrict("r7/8/8/8/8/4k3/8/4K3 w - - 0 1");
    ...
    // attacked by rf8.
    {
      final Board board = Board.fromFenStrict("5r2/8/8/k7/8/8/8/4K3 w - - 0 1");
  ...
  void testOverspecified() {
    ...
    {
      final Board board = Board.fromFenStrict("7k/8/8/8/8/8/8/R3K3 w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("7k/8/8/8/8/R5R1/8/6K1 w - - 0 1");
  ...
  void testInsufficientlySpecified() {
    ...
    {
      final Board board = Board.fromFenStrict("7k/8/8/8/8/R3R3/8/6K1 w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("k7/8/8/1Q6/2Q5/8/1Q6/K7 w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("8/3Q4/7k/8/1Q4Q1/8/8/K7 w - - 0 1");
  ...
  void testNonStandardSpecified() {
    ...
    {
      final Board board = Board.fromFenStrict("1k6/8/8/R7/8/7r/2R5/3K4 w - - 0 1");
  ...
  void testCheckCheckmateSymbol() {
    ...
    {
      final Board board = Board.fromFenStrict("4k3/Q7/8/8/8/8/8/4K3 w - - 0 1");
    ...
    {
      final Board board = Board.fromFenStrict("6k1/5ppp/8/8/8/8/8/1R5K w - - 0 1");

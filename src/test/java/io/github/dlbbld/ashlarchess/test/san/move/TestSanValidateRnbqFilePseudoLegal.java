...
class TestSanValidateRnbqFilePseudoLegal {
  ...
  void testWhiteNotReachableSingle() {
    ...
    final Board board = Board.fromFenStrict("k7/8/8/8/PPPPPPPP/8/1N1N4/2B1K3 w - - 0 1");
  ...
  void testBlackNotReachableSingle() {
    ...
    final Board board = Board.fromFenStrict("2b1k3/1n1n4/8/pppppppp/8/8/8/4K3 b - - 0 1");
  ...
  void testWhiteNotReachableMultiple() {
    ...
    final Board board = Board.fromFenStrict("7k/8/8/8/P7/R7/P7/R3K3 w - - 0 1");
  ...
  void testBlackNotReachableMultiple() {
    ...
    final Board board = Board.fromFenStrict("r3k3/p7/8/r7/P7/8/8/4K3 b - - 0 1");
  ...
  void testWhiteKingInCheckMultiple() {
    ...
    // so the position is not insufficient material. h7 does not interact with the test.
    final Board board = Board.fromFenStrict("k7/7p/8/4b3/3B4/2K5/3B4/4b3 w - - 0 1");
  ...
  void testBlackKingInCheckMultiple() {
    ...
    // so the position is not insufficient material. h2 does not interact with the test.
    final Board board = Board.fromFenStrict("4B3/3b4/2k5/3b4/4B3/8/7P/K7 b - - 0 1");
  ...
  void testWhiteKingLeftInCheckSingle() {
    ...
    final Board board = Board.fromFenStrict("4r2k/8/8/8/2B5/8/8/4K3 w - - 0 1");
  ...
  void testBlackKingLeftInCheckSingle() {
    ...
    final Board board = Board.fromFenStrict("4k3/8/8/2b5/8/8/8/4R2K b - - 0 1");

...
class TestAttackedSquaresByPlaying implements EnumConstants {
  ...
  void testKnightSquares() {
    ...
    // white
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares.calculateKnightAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), B1, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares.calculateKnightAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), G8, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares.calculateKnightAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C3, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares.calculateKnightAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), H6, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares.calculateKnightAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D5, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares.calculateKnightAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), G4, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares.calculateKnightAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F6, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares.calculateKnightAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), H2, BLACK);
  ...
  void testBishopSquares() {
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C1, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F1, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C8, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F8, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), B2, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C5, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D4, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), H8, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), B6, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F2, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), G1, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C4, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares.calculateBishopAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F7, WHITE);
  ...
  void testKingNonCastlingSquares() {
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares.calculateKingNonCastlingAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E1, WHITE);
      final Set<Square> expectedSquareSet = new TreeSet<>(Arrays.asList(D1, D2, E2, F2, F1));
      assertEquals(expectedSquareSet, potentialToSquareSet);
    }
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares.calculateKingNonCastlingAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E8, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares.calculateKingNonCastlingAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E2, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares.calculateKingNonCastlingAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D7, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares.calculateKingNonCastlingAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E3, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares.calculateKingNonCastlingAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D6, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares.calculateKingNonCastlingAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F4, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares.calculateKingNonCastlingAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E4, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares.calculateKingNonCastlingAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F3, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares.calculateKingNonCastlingAttackedSquares(
          StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E5, BLACK);

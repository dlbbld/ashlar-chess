  ...
  void testRookSquares() {
...

    {
      final Set<Square> potentialToSquareSet = RookAttackedSquares
          .calculateRookAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), A1, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = RookAttackedSquares
          .calculateRookAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), H1, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = RookAttackedSquares
          .calculateRookAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), A8, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = RookAttackedSquares
          .calculateRookAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), H8, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = RookAttackedSquares
          .calculateRookAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), A3, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = RookAttackedSquares
          .calculateRookAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D3, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = RookAttackedSquares
          .calculateRookAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), H5, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = RookAttackedSquares
          .calculateRookAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D5, WHITE);
      final Set<Square> expectedSquareSet = new TreeSet<>(
    ...
    {
      final Set<Square> potentialToSquareSet = RookAttackedSquares
          .calculateRookAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E5, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = RookAttackedSquares
          .calculateRookAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E3, BLACK);
  ...
  void testKnightSquares() {
    ...
    // white
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares
          .calculateKnightAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), B1, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares
          .calculateKnightAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), G8, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares
          .calculateKnightAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C3, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares
          .calculateKnightAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), H6, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares
          .calculateKnightAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D5, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares
          .calculateKnightAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), G4, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares
          .calculateKnightAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F6, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KnightAttackedSquares
          .calculateKnightAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), H2, BLACK);
  ...
  void testBishopSquares() {
...

    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C1, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F1, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C8, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F8, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), B2, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C5, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D4, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), H8, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), B6, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F2, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), G1, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C4, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = BishopAttackedSquares
          .calculateBishopAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F7, WHITE);
  ...
  void testQueenSquares() {
...

    {
      final Set<Square> potentialToSquareSet = QueenAttackedSquares
          .calculateQueenAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D1, WHITE);
      final Set<Square> expectedSquareSet = new TreeSet<>(Arrays.asList(C1, C2, D2, E2, E1));
      assertEquals(expectedSquareSet, potentialToSquareSet);
    }
    {
      final Set<Square> potentialToSquareSet = QueenAttackedSquares
          .calculateQueenAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D8, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = QueenAttackedSquares
          .calculateQueenAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), H5, WHITE);
      final Set<Square> expectedSquareSet = new TreeSet<>(
    ...
    {
      final Set<Square> potentialToSquareSet = QueenAttackedSquares
          .calculateQueenAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D5, WHITE);
      final Set<Square> expectedSquareSet = new TreeSet<>(
    ...
    {
      final Set<Square> potentialToSquareSet = QueenAttackedSquares
          .calculateQueenAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D6, BLACK);
      final Set<Square> expectedSquareSet = new TreeSet<>(
    ...
    {
      final Set<Square> potentialToSquareSet = QueenAttackedSquares
          .calculateQueenAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F7, WHITE);
      final Set<Square> expectedSquareSet = new TreeSet<>(
    ...
    {
      final Set<Square> potentialToSquareSet = QueenAttackedSquares
          .calculateQueenAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D2, BLACK);
      final Set<Square> expectedSquareSet = new TreeSet<>(
    ...
    {
      final Set<Square> potentialToSquareSet = QueenAttackedSquares
          .calculateQueenAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C2, BLACK);
      final Set<Square> expectedSquareSet = new TreeSet<>(
    ...
    {
      final Set<Square> potentialToSquareSet = QueenAttackedSquares
          .calculateQueenAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), G7, WHITE);
      final Set<Square> expectedSquareSet = new TreeSet<>(
  ...
  void testKingNonCastlingSquares() {
...

    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares
          .calculateKingNonCastlingAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E1, WHITE);
      final Set<Square> expectedSquareSet = new TreeSet<>(Arrays.asList(D1, D2, E2, F2, F1));
      assertEquals(expectedSquareSet, potentialToSquareSet);
    }
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares
          .calculateKingNonCastlingAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E8, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares
          .calculateKingNonCastlingAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E2, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares
          .calculateKingNonCastlingAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D7, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares
          .calculateKingNonCastlingAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E3, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares
          .calculateKingNonCastlingAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D6, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares
          .calculateKingNonCastlingAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F4, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares
          .calculateKingNonCastlingAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E4, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares
          .calculateKingNonCastlingAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F3, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = KingNonCastlingAttackedSquares
          .calculateKingNonCastlingAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E5, BLACK);
  ...
  void testPawnSquares() {
...

    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C2, WHITE);
      final Set<Square> expectedSquareSet = new TreeSet<>(Arrays.asList(B3, D3));
      assertEquals(expectedSquareSet, potentialToSquareSet);
    }
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F7, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), C4, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F5, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), A4, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), G4, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), H3, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), A5, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), B6, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), H2, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), A7, WHITE);
    ...
    }
    {
      // we check the queen
      final Set<Square> potentialToSquareSet = QueenAttackedSquares
          .calculateQueenAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), G1, BLACK);
    ...
    }
    {
      // we check the queen
      final Set<Square> potentialToSquareSet = QueenAttackedSquares
          .calculateQueenAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), B8, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), D5, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), B5, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), E4, BLACK);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F4, WHITE);
    ...
    {
      final Set<Square> potentialToSquareSet = PawnAttackedSquares
          .calculatePawnAttackedSquares(StaticPositionBridge.toStaticPosition(board.getBitboardPosition()), F5, WHITE);
      final Set<Square> expectedSquareSet = new TreeSet<>(Arrays.asList(E6, G6));
      assertEquals(expectedSquareSet, potentialToSquareSet);
    }
    {

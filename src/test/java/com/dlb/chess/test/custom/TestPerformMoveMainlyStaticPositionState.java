...
class TestPerformMoveMainlyStaticPositionState implements EnumConstants {
  ...
  void testGameWithMostBasicMoves() {
    ...
    assertEquals(staticPosition0, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());

    StaticPosition workingPosition = BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition());
    ...
    assertEquals(staticPosition1W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    assertEquals("e4", apiBoard.getSan());
    assertEquals("e2e4", apiBoard.getLan());

    workingPosition = BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition());
    ...
    assertEquals(staticPosition1B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition2W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition2B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition3W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition3B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition4W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition4B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition5W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition5B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition6W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition6B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition7W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition7B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition8W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition8B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition9W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition9B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition10W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition10B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition11W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition11B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition12W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition12B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition13W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition13B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition14W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition14B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition15W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition15B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition16W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition16B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition17W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition17B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition18W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition18B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition19W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition19B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition20W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition20B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition21W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition21B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition22W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition22B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition23W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition23B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition24W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition24B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition25W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    assertEquals("Nxe5", apiBoard.getSan());
    ...
    assertEquals(staticPosition25B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition26W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition26B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition27W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition27B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition28W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition28B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition29W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition29B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition30W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    assertEquals("Qxd5", apiBoard.getSan());
    ...
    assertEquals(staticPosition30B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition31W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition31B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition32W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition32B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition33W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition33B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition34W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition34B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition35W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition35B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition36W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition36B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition37W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    assertEquals("Qc3", apiBoard.getSan());
    ...
    assertEquals(staticPosition37B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition38W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition38B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition39W, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(BLACK, apiBoard.getHavingMove());
    ...
    assertEquals(staticPosition39B, BitboardPositionUtility.toStaticPosition(apiBoard.getBitboardPosition()));
    assertEquals(WHITE, apiBoard.getHavingMove());
    assertEquals("Kxf5", apiBoard.getSan());

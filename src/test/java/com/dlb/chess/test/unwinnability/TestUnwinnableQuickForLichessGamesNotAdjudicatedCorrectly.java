...
class TestUnwinnableQuickForLichessGamesNotAdjudicatedCorrectly {

  private static final Logger logger = Nulls.getLogger(TestUnwinnableQuickForLichessGamesNotAdjudicatedCorrectly.class);
